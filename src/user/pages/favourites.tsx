...
export const Favorites: React.FC = () => {
  ...
  const favorites = properties.filter((item) => Boolean(item.isFavorite));
  const filterOptions = [
        ...
        <div className="mt-12">
          <div className="max-w-3xl mx-auto text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gray-800 text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-900 transition-all" onClick={() => navigate('/search')}>
                Qidirishga qaytish
              </button>
              <button className="bg-white border border-gray-800 backdrop-blur-sm text-gray-800 px-6 py-3 rounded-lg font-medium hover:opacity-80 transition-all" onClick={() => navigate('/search')}>
