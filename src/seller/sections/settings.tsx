                        ...
                        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                            ...
                            <div className="flex items-center mb-6">
                                <div className="relative">
                                    ...
                                    <button className="absolute -bottom-1 -right-1 bg-gray-100 rounded-full p-1 hover:bg-gray-600  transform hover:scale-110 transition-all duration-200">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Автоматическое продление объявлений</label>
                                    <select className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 pr-10"
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                                ...
                                {tabs.map((tab) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full flex items-center px-4 py-3 text-left rounded-lg transition-all duration-200 transform hover:scale-105 ${activeTab === tab.id
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-8 flex justify-end">
                            <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-medium flex items-center space-x-2 transform hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg">
